...
class AppColors {
  // Primary Colors - Professional Blue for energy & reliability
  static const Color primary = Color(0xFF1E6091); // Professional Blue - main brand color
  static const Color primaryDark = Color(0xFF154A6F); // Darker blue for pressed states
  static const Color primaryLight = Color(0xFF3B8BC4); // Lighter blue for hover states
  static const Color primaryUltraLight = Color(0xFFE6F2F8); // Ultra light blue for backgrounds
  ...
  static const Color info = Color(0xFF1E6091); // Blue for info (same as primary)
  static const Color infoLight = Color(0xFFE6F2F8); // Light blue background
  ...
  static const Color borderAccent = Color(0xFF1E6091); // Accent border - primary color
  ...
  static const Color shadowColored = Color.fromRGBO(30, 96, 145, 0.15); // Colored shadow for primary elements
